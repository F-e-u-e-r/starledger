...
| P4     | Reusable **template** (fork model, no key custody): setup doctor + deterministic export | ✅ complete — template published; hosted clean-room deployment passed; notifier and AI remain explicit opt-ins |
